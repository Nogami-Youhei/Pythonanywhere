...
class ShapForm(forms.Form):
    ...
    n_estimators_div = forms.IntegerField(label='平均する決定木の分割数', min_value=1)
    max_depth_min = forms.IntegerField(label='深さの最小値', min_value=1)
    max_depth_max = forms.IntegerField(label='深さの最大値', min_value=1)
    max_depth_div = forms.IntegerField(label='深さの分割数', min_value=1)
    ...
    max_features_div = forms.IntegerField(label='特徴量の分割数', min_value=1)
